...
import com.ih.api.service.HeatexchangerunitService
...
@CrossOrigin("*")
@RequestMapping("/api/heatexchangerunit/")
@Controller
class HeatexchangerunitControllerApi {
    @Resource
...
/*
    ...
    //过滤条件：优先用searchCompanyID约束，如果没有选择，则再用binCompanyID查找，这样可以有效过滤
    ...
    * */
    ...
    @ResponseBody
    fun getByName(@RequestParam(name = "unitNumber", required = true) unitNumber: String,
                  @RequestParam(name = "stationID", defaultValue = "0", required =true) stationID: Int,
