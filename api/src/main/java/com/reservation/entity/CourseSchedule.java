...
public class CourseSchedule implements Serializable {
    ...
    private int repeat_type;//重复类型：0=不重复，1=每天，2=每周，3=每月
    private int repeat_interval;//重复间隔（如每2周一次=2）
    private String repeat_days;//重复的星期几：1=周一，2=周二...7=周日，逗号分隔（仅repeat_type=2时有效），type=3时为1-31,当月的那几天，如（1，3，5，7） ，（1，11，21）
    private Date repeat_end_date;  //重复结束时间（精确到秒）
    private int available_sites;//可预定数量，缺省为1，可填写，
