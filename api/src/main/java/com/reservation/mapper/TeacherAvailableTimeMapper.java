...
public interface TeacherAvailableTimeMapper extends BaseMapper<TeacherAvailableTime> {
     ...
     * ORDER BY repeat_type ASC, start_date ASC, start_time ASC")
     */
    @Select("SELECT * FROM teacher_available_time WHERE teacher_id = #{teacherId} ORDER BY start_date ASC, start_time ASC")
